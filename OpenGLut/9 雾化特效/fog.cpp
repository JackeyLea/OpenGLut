...
#include <X11/Xlib.h> //standard x header
#include <X11/Xatom.h> //provide x atom function
#include <X11/keysym.h> //provide keyboard function
#include <unistd.h>//延时
...
GLuint fogfilter=0;//switch fog mode
GLfloat fogColor[4]={0.1f,0.5f,0.5f,1.0f};//fog color
...
void initGL(int width, int height)
{
    ...
    glClearColor(0.5f, 0.5f, 0.5f, 1.0f); //将界面背景清空为红绿蓝alpha值对应的颜色
